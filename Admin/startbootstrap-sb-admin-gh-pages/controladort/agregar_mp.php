...
<body>
  ...
  <h1 class="mt-4 text-center">Agregar Materias primas Usadas</h1>
 ...
 <div class="formulario">
  <form method="post" >
    ...
    ?>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Libras</label>
    <input type="text" class="form-control" name="libras" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">kilos</label>
