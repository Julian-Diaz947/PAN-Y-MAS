...
// Declaramos la clase ProductoProceso que manejará la lógica para los productos horneados.
class ProductoProceso
{
    ...
    // Función pública para insertar un nuevo producto en proceso. Se ejecuta cuando el formulario se envía.
    public function insertarProductoProceso()
    {
    ...
    {
        // SQL para insertar el producto en proceso.
        $sql = "INSERT INTO producto_prcso (nombre, cantidad, empleado_id) VALUES (?, ?, ?)";
...
$controlador = new ProductoProceso($conexion);

// Si la solicitud es de tipo POST (es decir, cuando el formulario es enviado), llamamos a la función insertarProductoProceso.
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $controlador->insertarProductoProceso();
}
