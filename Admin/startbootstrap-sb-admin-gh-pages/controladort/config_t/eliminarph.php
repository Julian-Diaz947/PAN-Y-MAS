...
// Definición de la clase EliminarProductoHorneado para manejar la eliminación de productos horneados
class EliminarProductoHorneado {
    ...
    public function eliminar() {
        try {
            ...
            $query = "DELETE FROM productos_horneados WHERE id_horneado = ?";
...
try {
    ...
    if (!empty($_GET['id'])) {
        // Crear una instancia de EliminarProductoHorneado y ejecutar el proceso de eliminación
        $producto = new EliminarProductoHorneado($conexion);
