...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/pasteles.css?v=<?php echo time(); ?>">
            ...
            <article class="fondo2">
                <article class="ventana-contenido">
                    ...
                    <article class="descripcion">
                        <h1 class="titulo">PASTELES</h1>
                        <p class="precio"><b>25.000 COP</b></p>
                        <p class="descripcion"><b>DESCRIPCIÓN:</b>Pastel mediano con ingredientes al pedido
                        </p>
                        <p class="stock"><b>CANTIDAD DISPONIBLE:</b> 9
                        </p>
