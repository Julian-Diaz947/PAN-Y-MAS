        ...
        <article class="ventana">
            <article class="fondo2">
                <article class="ventana-contenido">
                    ...
                    <div class="imgmpr"></div>
                    <article class="descripcion">
                        <h1 class="titulo">PAN GRANDE</h1>
                        <p class="precio"><b>4.000 COP</b></p>
                        <p class="descripcion"><b>DESCRIPCIÓN:</b>Pan de maíz con queso campesino
                        </p>
                        <p class="stock"><b>CANTIDAD DISPONIBLE:</b> 15
                        </p>
