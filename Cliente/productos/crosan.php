...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/croasan.css?v=<?php echo time(); ?>">
            ...
            <article class="fondo2">
                <article class="ventana-contenido">
                    ...
                    <article class="descripcion">
                        <h1 class="titulo">CROASANT</h1>
                        <p class="precio"><b>1.000 COP</b></p>
                        <p class="descripcion"><b>DESCRIPCIÓN:</b>Croasant de queso con bocadillo
                        </p>
