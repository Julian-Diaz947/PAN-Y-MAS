...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/leche-asada.css?v=<?php echo time(); ?>">
    ...
    <header class="head">
     ...
     <section class="fondo">
        ...
        <article class="produc" id="productos">
            ...
            <a class="a" href="/productos/producto1.html"><input type="button"value="VER MÁS" required></a>
        </article>
            ...
            <article class="fondo2">
                <article class="ventana-contenido">
                    ...
                    <article class="descripcion">
                        <h1 class="titulo">LECHE ASADA</h1>
                        <p class="precio"><b>2.500 COP</b></p>
                        <p class="descripcion"><b>DESCRIPCIÓN:</b>Elaborado principalmente con leche, azúcar, huevos y vainilla. 
                        </p>
                        <p class="stock"><b>CANTIDAD DISPONIBLE:</b> 30
                        </p>
