...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/galletas.css?v=<?php echo time(); ?>">
            ...
            <article class="fondo2">
                <article class="ventana-contenido">
                    ...
                    <article class="descripcion">
                        ...
                        <p class="precio"><b>1.500 COP</b></p>
                        <p class="descripcion"><b>DESCRIPCIÓN:</b>Galletas hechas de harina de trigo y chispas de chocolate 
                        </p>
                        <p class="stock"><b>CANTIDAD DISPONIBLE:</b> 100
                        </p>
